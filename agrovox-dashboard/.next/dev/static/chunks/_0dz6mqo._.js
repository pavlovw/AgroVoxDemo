...
"[project]/src/app/clientes/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MapaDinamico = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/clientes/Mapa.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/src/components/clientes/Mapa.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    ssr: false,
    loading: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "w-full h-full bg-gray-100 animate-pulse rounded-xl flex items-center justify-center text-gray-400 font-medium border border-gray-200",
...
function Clientes() {
    ...
    const [clienteActivo, setClienteActivo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Clientes.useEffect": ()=>{
            // Obtenemos los clientes reales desde la API
            fetch('http://localhost:3001/api/clientes').then({
                "Clientes.useEffect": (res)=>res.json()
            }["Clientes.useEffect"]).then({
                "Clientes.useEffect": (data)=>{
                    if (Array.isArray(data)) {
                        // Procesamos los datos para facilitar el renderizado en las tarjetas
                        const clientesProcesados = data.map({
                            "Clientes.useEffect.clientesProcesados": (cli)=>{
                                const cultivos = Array.from(new Set(cli.sectores?.map({
                                    "Clientes.useEffect.clientesProcesados.cultivos": (s)=>s.cultivo
                                }["Clientes.useEffect.clientesProcesados.cultivos"]).filter(Boolean)));
                                const cultivoPrincipal = cultivos.length > 0 ? cultivos.join(', ') : 'Sin cultivo';
                                const totalNodos = cli.sectores?.reduce({
                                    "Clientes.useEffect.clientesProcesados": (acc, sector)=>acc + (sector.nodos?.length || 0)
                                }["Clientes.useEffect.clientesProcesados"], 0) || 0;
                                const enAlerta = cli.sectores?.some({
                                    "Clientes.useEffect.clientesProcesados": (sector)=>sector.nodos?.some({
                                            "Clientes.useEffect.clientesProcesados": (nodo)=>nodo.estado === 'ALERTA'
                                        }["Clientes.useEffect.clientesProcesados"])
                                }["Clientes.useEffect.clientesProcesados"]);
                                return {
                                    ...cli,
                                    cultivoPrincipal,
            ...
            }["Clientes.useEffect"]).catch({
                "Clientes.useEffect": (err)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full lg:w-1/2 h-64 lg:h-full bg-white rounded-xl shadow-sm border border-gray-100 p-2",
                children: !cargando && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MapaDinamico, {
                    clientes: clientes,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full lg:w-1/2 h-full flex flex-col bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Selecciona un fundo para localizarlo en el mapa."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/clientes/page.tsx",
                                        lineNumber: 65,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "bg-agrogreen-600 hover:bg-agrogreen-700 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors",
                                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: cargando ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "text-center text-gray-500 mt-10 animate-pulse",
                  ...
                  ${clienteActivo?.id === cliente.id ? 'border-agrogreen-500 bg-agrogreen-50' : 'border-transparent bg-gray-50 hover:bg-gray-100'}`,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    ${cliente.estado === 'alerta' ? 'bg-red-100 text-red-500' : 'bg-agrogreen-100 text-agrogreen-600'}`,
                                                children: cliente.estado === 'alerta' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__["AlertTriangle"], {
                                                    className: "w-5 h-5"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/clientes/page.tsx",
                                                    lineNumber: 92,
...
_s(Clientes, "0+Vffc7spPhqUQp1rwK1UGb/KJk=");
_c1 = Clientes;
var _c, _c1;
__turbopack_context__.k.register(_c, "MapaDinamico");
__turbopack_context__.k.register(_c1, "Clientes");
...
//# sourceMappingURL=_0dz6mqo._.js.map